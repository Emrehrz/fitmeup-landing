<template>
  <div class="w-full h-auto  py-24 sm:px-6 sm:py-32 lg:px-8">
    <div
      ...
      <div class="max-w-lg text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
        <h2 class="text-3xl font-semibold tracking-tight text-balance text-white sm:text-4xl">Boost your productivity.
          Start using our app today.</h2>
        <p class="mt-6 text-lg/8 text-pretty text-gray-300">Ac euismod vel sit maecenas id pellentesque eu sed
      ...
      <div class="relative mt-16 h-80 lg:mt-8">
        <img class="absolute top-0 left-0 w-[57rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10"
          src="../assets/img/Login.webp" alt=" App screenshot" width="1824" height="1080" />
      </div>
    </div>
  </div>
</template>
